...
public class IncidenceArrayGraph implements Graph{
    ...
    public void addVertex(Vertex v){
        this.vertices[this.ndOfVertices()+1] = v;
    }

    public void addEdge(Vertex v1, Vertex v2, EdgeKind edgeKind){
        Edge edge;
        if(edgeKind == EdgeKind.undirected){
            edge = new DirectedEdge(this.nbOfEdge() + 1, "blue", new Vertex[]{v1, v2}, 1,0);
        } else {
            edge = new UndirectedEdge(this.nbOfEdge() + 1, "blue", new Vertex[]{v1, v2}, 1);
        }
    ...
    public boolean isConnected(){
        ...
        int i = 1;
        while(isConnected && i < this.ndOfVertices()){
